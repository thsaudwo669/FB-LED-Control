...
// 데이터 베이스 호스트 이름
#define FIREBASE_HOST  "fb-led-web-android-02-default-rtdb.firebaseio.com"

// 데이터 베이스 비밀번호
#define FIREBASE_AUTH "ebVvO0mtvAIjQKqAZ2fIsHW9JxVCDYug3fuaOBZG"

// Wi-Fi 설정
#define WIFI_SSID "iptime"
#define WIFI_PASSWORD "ditcs703"
